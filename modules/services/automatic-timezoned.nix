...
let
  ...
  package = pkgs.callPackage (import ../pkgs/automatic-timezoned.nix) { };
in
{
  options = {
    services.automatic-timezoned = {
      enable = mkOption {
        ...
        default = false;
        description = ''
          Enable <literal>automatic-timezoned</literal>, simple daemon for keeping the system
  ...
  config = mkIf cfg.enable {
    ...
    services.geoclue2 = {
      ...
      appConfig.automatic-timezoned = {
        isAllowed = true;
        isSystem = true;
        # users = [ "${config.ids.uids.automatic-timezoned}" ];
      };
    };
    ...
    systemd.services = {
      ...
      automatic-timezoned = {
        ...
        serviceConfig = {
          ...
          ExecStart = "${package}/bin/automatic-timezoned --zoneinfo-path=${pkgs.tzdata}/share/zoneinfo/zone1970.tab";
        };
    ...
    users.users.automatic-timezoned = {
    ...
    users.groups.automatic-timezoned = {
